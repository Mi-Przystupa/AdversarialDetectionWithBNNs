...
class MLP(nn.Module):
    def __init__(self, n_input, sigma_prior):
        ...
        self.l1 = MLPLayer(n_input, 400, sigma_prior)
        self.l1_relu = nn.ReLU()
        self.l2 = MLPLayer(400, 400, sigma_prior)
        self.l2_relu = nn.ReLU()
        self.l3 = MLPLayer(400, 10, sigma_prior)
...
#mnist_tensorflow = input_data.read_data_sets("MNIST_data/",one_hot=False)
class mnist:
    def __init__(self):
